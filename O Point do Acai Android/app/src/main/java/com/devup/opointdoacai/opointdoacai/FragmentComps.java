...
public class FragmentComps extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_comps, container, false);

        //Firebase Instance
        database = FirebaseDatabase.getInstance();
        compList = database.getReference("Comps");

        recyclerView = view.findViewById(R.id.recycler_complementos_comp);
    ...
    private void loadListComps() {
        ...
        Query search = compList.orderByChild("type").equalTo("complemento");
