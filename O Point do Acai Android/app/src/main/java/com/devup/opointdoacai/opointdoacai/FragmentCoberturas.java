...
public class FragmentCoberturas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_coberturas, container, false);

        //Firebase Instance
        database = FirebaseDatabase.getInstance();
        compList = database.getReference("Comps");

        recyclerView = view.findViewById(R.id.recycler_coberturas_comp);
    ...
    private void loadListComps() {
        ...
        Query search = compList.orderByChild("type").equalTo("cobertura");
